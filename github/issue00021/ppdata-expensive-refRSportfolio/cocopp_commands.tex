...
\providecommand{\cocoversion}{\hspace{\textwidth}\scriptsize\sffamily{}\color{Gray}Data produced with COCO v2.0.480}
\providecommand{\numofalgs}{2+}
\providecommand{\bbobECDFslegend}[1]{
Bootstrapped empirical cumulative distribution of the number of objective function evaluations divided by dimension (FEvals/DIM) for all functions and subgroups in #1-D. The targets are chosen from $10^{[-8..2]}$ such that the reference algorithm just not reached them within a given budget of $k$ $\times$ DIM, with $31$ different values of $k$ chosen equidistant in logscale within the interval $\{0.5, \dots, 50\}$. As reference algorithm, ``RS-portfolio`` is shown as light thick line with diamond markers.
}
...
\providecommand{\algBtables}{\StrLeft{BIPOP-CMA-ES hansen noiseless}{\ntables}}
...
\providecommand{\algFtables}{\StrLeft{lmm-CMA-ES auger noiseless}{\ntables}}
\providecommand{\algEtables}{\StrLeft{SMAC-BBOB hutter noiseless}{\ntables}}
\providecommand{\algDtables}{\StrLeft{HCMA loshchilov noiseless}{\ntables}}
\providecommand{\algCtables}{\StrLeft{RANDOMSEARCH auger noiseless}{\ntables}}
\providecommand{\algBtables}{\StrLeft{BIPOP-CMA-ES hansen noiseless}{\ntables}}
\providecommand{\algAtables}{\StrLeft{BFGS ros noiseless}{\ntables}}
\providecommand{\ntables}{5}
...
\providecommand{\bbobpptablesmanylegend}[2]{%
        ...
        than 1, with Bonferroni correction of #2. A $\downarrow$ indicates the same tested against the reference algorithm. Best results are printed in bold.
        \cocoversion}
\providecommand{\algsfolder}{RANDO_BIPOP_BFGS__SMAC-_lmm-C_HCMA/}
\providecommand{\algorithmA}{RANDOMSEARCH auger noiseless}
\providecommand{\algorithmB}{BIPOP-CMA-ES hansen noiseless}
\providecommand{\algorithmC}{BFGS ros noiseless}
\providecommand{\algorithmD}{SMAC-BBOB hutter noiseless}
\providecommand{\algorithmE}{lmm-CMA-ES auger noiseless}
\providecommand{\algorithmF}{HCMA loshchilov noiseless}
\providecommand{\algsfolder}{RANDO_BIPOP_ALPS__BFGS__SMAC-_lmm-C/}
\providecommand{\algorithmA}{RANDOMSEARCH auger noiseless}
\providecommand{\algorithmB}{BIPOP-CMA-ES hansen noiseless}
\providecommand{\algorithmC}{ALPS hornby noiseless}
\providecommand{\algorithmD}{BFGS ros noiseless}
\providecommand{\algorithmE}{SMAC-BBOB hutter noiseless}
\providecommand{\algorithmF}{lmm-CMA-ES auger noiseless}
