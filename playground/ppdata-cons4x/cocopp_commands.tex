...
\providecommand{\cocoversion}{\hspace{\textwidth}\scriptsize\sffamily{}\color{Gray}Data produced with COCO v2.2.1.112}
\providecommand{\numofalgs}{2+}
...
\providecommand{\algDtables}{\StrLeft{fmin slsqp from scipy.optimize.slsqp 1000D on bbob-constrained}{\ntables}}
\providecommand{\algCtables}{\StrLeft{fmin cobyla rho-9 catol-9 from scipy.optimize.cobyla 1000D on bbob-constrained}{\ntables}}
\providecommand{\algBtables}{\StrLeft{fmin2 from cma.evolution strategy 1000D on bbob-constrained-005}{\ntables}}
\providecommand{\algAtables}{\StrLeft{fmin2 from cma.evolution strategy 1000D on bbob-constrained-001}{\ntables}}
\providecommand{\ntables}{7}
\providecommand{\ntables}{7}
\providecommand{\ntables}{7}
\providecommand{\bbobpptablesmanylegend}[1]{%
        ...
        \cocoversion}
\providecommand{\algsfolder}{fmin2_fmin2_fmin__fmin__rando/}
\providecommand{\algorithmA}{fmin cobyla rho-9 catol-9 from scipy.optimize.cobyla 1000D on bbob-constrained}
\providecommand{\algorithmB}{fmin slsqp from scipy.optimize.slsqp 1000D on bbob-constrained}
\providecommand{\algorithmC}{fmin2 from cma.evolution strategy 1000D on bbob-constrained-001}
\providecommand{\algorithmD}{fmin2 from cma.evolution strategy 1000D on bbob-constrained-005}
\providecommand{\algorithmE}{random search of cocoex.solvers 1000D on bbob}
