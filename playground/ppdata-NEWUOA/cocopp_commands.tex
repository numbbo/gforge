...
\providecommand{\cocoversion}{\hspace{\textwidth}\scriptsize\sffamily{}\color{Gray}Data produced with COCO v2.0.805}
\providecommand{\numofalgs}{2+}
...
\providecommand{\algDtables}{\StrLeft{DFO}{\ntables}}
\providecommand{\algCtables}{\StrLeft{AVGNEWUOA ros noiseless}{\ntables}}
\providecommand{\algBtables}{\StrLeft{NEWUOA ros noiseless}{\ntables}}
\providecommand{\algAtables}{\StrLeft{FULLNEWUOA ros noiseless}{\ntables}}
\providecommand{\ntables}{7}
\providecommand{\ntables}{7}
\providecommand{\ntables}{7}
\providecommand{\bbobpptablesmanylegend}[1]{%
        ...
        \cocoversion}
\providecommand{\algsfolder}{FULLN_NEWUO_AVGNE_DFO/}
\providecommand{\algorithmA}{AVGNEWUOA ros noiseless}
\providecommand{\algorithmB}{DFO}
\providecommand{\algorithmC}{FULLNEWUOA ros noiseless}
\providecommand{\algorithmD}{NEWUOA ros noiseless}
\providecommand{\algorithmA}{AVGNEWUOA ros noiseless}
\providecommand{\algorithmB}{DFO}
\providecommand{\algorithmC}{FULLNEWUOA ros noiseless}
\providecommand{\algorithmD}{NEWUOA ros noiseless}
\providecommand{\algorithmA}{AVGNEWUOA ros noiseless}
\providecommand{\algorithmB}{FULLNEWUOA ros noiseless}
\providecommand{\algorithmC}{NEWUOA ros noiseless}
