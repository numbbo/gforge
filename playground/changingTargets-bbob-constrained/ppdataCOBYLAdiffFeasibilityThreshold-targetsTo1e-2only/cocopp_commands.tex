...
Empirical cumulative distribution of simulated (bootstrapped)
             ...
             divided by dimension (FEvals/DIM) for the $21$ 
...
Bootstrapped empirical cumulative distribution of the number of objective function evaluations divided by dimension (FEvals/DIM) for $21$ targets with target precision in $10^{[-8..2]}$ for all functions and subgroups in #1-D. 
}
...
\providecommand{\algBtables}{\StrLeft{cobyla 1e-5feasthresh-on bbob-constrained budget1234xD-001}{\ntables}}
...
\providecommand{\algorithmB}{cobyla 1e-5feasthresh-on bbob-constrained budget1234xD-001}
\providecommand{\algsfolder}{cobyl_cobyl/}
