...
Empirical cumulative distribution of simulated (bootstrapped)
             ...
             divided by dimension (FEvals/DIM) for the $31$ 
...
Bootstrapped empirical cumulative distribution of the number of objective function evaluations divided by dimension (FEvals/DIM) for $31$ targets with target precision in $10^{[-8..2]}$ for all functions and subgroups in #1-D. 
}
