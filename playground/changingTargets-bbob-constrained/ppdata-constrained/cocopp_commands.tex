...
\providecommand{\cocoversion}{\hspace{\textwidth}\scriptsize\sffamily{}\color{Gray}Data produced with COCO v2.0.361}
\providecommand{\numofalgs}{3+}
...
\providecommand{\algCtables}{\StrLeft{augmented lagrangian constraint handling on bbob-constrained feas thresh 0.0 budget1500xD}{\ntables}}
\providecommand{\algBtables}{\StrLeft{fmincon 0.0 feas thresh on bbob-constrained bound constraints budget1500xD}{\ntables}}
\providecommand{\algAtables}{\StrLeft{cobyla 0.0feasthresh-on bbob-constrained budget1234xD}{\ntables}}
\providecommand{\ntables}{7}
\providecommand{\pptablesfooter}{
\end{tabularx}
}
...
\providecommand{\bbobpptablesmanylegend}[2]{%
        ...
        \cocoversion}
\providecommand{\algsfolder}{cobyl_fminc_augme/}
\providecommand{\algorithmA}{cobyla 0.0feasthresh-on bbob-constrained budget1234xD}
\providecommand{\algorithmB}{fmincon 0.0 feas thresh on bbob-constrained bound constraints budget1500xD}
\providecommand{\algorithmC}{augmented lagrangian constraint handling on bbob-constrained feas thresh 0.0 budget1500xD}
