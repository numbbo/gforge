...
\providecommand{\cocoversion}{\hspace{\textwidth}\scriptsize\sffamily{}\color{Gray}Data produced with COCO v2.3.1.31, hv-hash=ff0e71e8cd978373}
\providecommand{\numofalgs}{3}
...
\providecommand{\algCtables}{\StrLeft{UP-MO-CMA-ES Krause bbob-biobj}{\ntables}}
\providecommand{\algBtables}{\StrLeft{NSGA-II-MATLAB Auger bbob-biobj}{\ntables}}
\providecommand{\algAtables}{\StrLeft{DMS on bbob-biobj-1e5funevals}{\ntables}}
\providecommand{\ntables}{4}
\providecommand{\ntables}{4}
\providecommand{\ntables}{4}
\providecommand{\bbobpptablesmanylegend}[1]{%
        ...
        \cocoversion}
\providecommand{\algsfolder}{DMS_o_NSGA-_UP-MO/}
\providecommand{\algorithmA}{DMS on bbob-biobj-1e5funevals}
\providecommand{\algorithmB}{NSGA-II-MATLAB Auger bbob-biobj}
\providecommand{\algorithmC}{UP-MO-CMA-ES Krause bbob-biobj}
